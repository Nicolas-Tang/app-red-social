const urlBase = `https://jsonplaceholder.typicode.com/posts`; //URL para interactuar
let post = []; //Iniciamos los posteos con un array vacio
...
function postData() {
    ...
    .catch(error => alert('Error al querer crear el posteo:', error))
}
...
function updatePost(id) {
    ...
    .catch(error => console.error('Error al querer modificar el posteo:', error))
}
